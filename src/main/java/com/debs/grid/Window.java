...
public class Window {
	...
	static HashMap<String, Integer> frequencyCube = new HashMap<String, Integer>();
	...
	public void addNewTripEvent(TripEvent newTripEvent) {
		...
		for (TripEvent tripEvent : currentEvents) {
			if(tripEvent.endTime.compareTo(this.startTime)<0) {
				...
				String key = tripEvent.startCell.xCell.toString() + tripEvent.startCell.yCell.toString() + tripEvent.endCell.xCell.toString() + tripEvent.endCell.yCell.toString();
		...
		String newKey = newTripEvent.startCell.xCell.toString() + newTripEvent.startCell.yCell.toString() + newTripEvent.endCell.xCell.toString() + newTripEvent.endCell.yCell.toString();
